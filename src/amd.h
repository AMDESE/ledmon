...
enum amd_device_type {AMD_SATA_DEVICE = 1, AMD_NVME_DEVICE};
...
enum amd_led_interfaces {AMD_INTF_UNSET, AMD_INTF_SGPIO, AMD_INTF_IPMI};
extern enum amd_led_interfaces amd_interface;

enum amd_platforms {AMD_PLATFORM_UNSET, AMD_PLATFORM_ETHANOL_X,
		    AMD_PLATFORM_DAYTONA_X, AMD_PLATFORM_GRANDSTAND,
